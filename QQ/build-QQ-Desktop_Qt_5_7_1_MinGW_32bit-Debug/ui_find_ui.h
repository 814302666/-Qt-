...
public:
    ...
    void setupUi(QWidget *Find_ui)
    {
        if (Find_ui->objectName().isEmpty())
            Find_ui->setObjectName(QStringLiteral("Find_ui"));
...
"}"));
    ...
    {
        Find_ui->setWindowTitle(QApplication::translate("Find_ui", "Form", Q_NULLPTR));
        toolButton_3->setText(QApplication::translate("Find_ui", "...", Q_NULLPTR));
        label_3->setText(QApplication::translate("Find_ui", "TextLabel", Q_NULLPTR));

...
void Friendlist_line::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Friendlist_line *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (Friendlist_line::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Friendlist_line::mycliked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Friendlist_line::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Friendlist_line.data,
    qt_meta_data_Friendlist_line,
    qt_static_metacall,
    nullptr,
    nullptr
} };
